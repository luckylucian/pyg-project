...
public class CartServiceImpl implements CartService{
    ...
    public List<Cart> addGoodsToCartList(List<Cart> cartList, Long itemId, Integer num) {
        ...
        //3. 根据商家 ID 判断购物车列表中 是否存在该商家的购物车
        ...
        if (cart == null){  //4. 如果购物车列表中不存在该商家的购物车
            ...
            }else { //5.2 如果有，在原购物车明细上添加数量，并更改金额
    ...
    public List<Cart> mergeCartList(List<Cart> cartList1, List<Cart> cartList2) {
        ...
        System.out.println("cartList2 == "+cartList2.toString());

        for (Cart cart : cartList2) {
            for(TbOrderItem orderItem : cart.getOrderItemList()){
                System.out.println("mergeCartList == " + orderItem.toString());
                System.out.println("mergeCartList == " + orderItem.getId());
